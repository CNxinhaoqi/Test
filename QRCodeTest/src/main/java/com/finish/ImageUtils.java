...
public class ImageUtils {
    ...
    public static void CutImages(File file){
    ...
    public static void CutImage(String fileUrl){
        String substring = fileUrl.substring(13, fileUrl.length() - 5);
        //读取原图像
        ...
        //保存图像
        Imgcodecs.imwrite("D:/CutImages/"+substring+".jpg", qrCodeImg);
...
//        Imgcodecs.imwrite("D:\\testImg.jpg", testImg);
     ...
     * @return
     */
    public static Point[] convertPoints(List<MatOfPoint> points) {
